...
if wget -q https://github.com/4nni33/AnnieV3/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/4nni33/AnnieV3.git
...
echo -e "\033[01;32m\033[01mIniciando AnnieV3!!\nBy HacheJota!!\n\033[0m"
npm start
